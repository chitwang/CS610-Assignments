...
int main() {
  uint64_t SIZE = N * N * N;
  std::cout << "The program will run CPU version and a shared memory CUDA Kernel using only limited number of worker threads and some loop transformations for stencil\n#############Results##############\n";
  // Initialisation
